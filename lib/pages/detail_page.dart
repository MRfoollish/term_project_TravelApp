...
import 'package:term_project/misc/colors.dart';
import 'package:term_project/widgets/app_buttons.dart';
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 5,),
                        AppText(text: "จำนวนคนในกลุ่มของคุณ", color: AppColors.mainTextColor,),
                        SizedBox(height: 10,),
                        Wrap(
                          children: List.generate(5, (index){
                            return InkWell(
                        ...
                        SizedBox(height: 20,),
                        AppLargeText(text: "คำอธิบาย", color: Colors.black.withOpacity(0.8), size: 20),
                        SizedBox(height: 10,),
